...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link size="" url="Server=gisserver_skala_250K; Service=sde:sqlserver:gisserver\skala_250K; Database=Indonesia_250K; Version=dbo.DEFAULT" format="" description="" type="ArcSDE Connection" name="SDE Feature Class" mimeType=""/>
  </links>
  <dates/>
  <fees></fees>
